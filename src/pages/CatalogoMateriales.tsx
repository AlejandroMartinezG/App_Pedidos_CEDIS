...
export function CatalogoMateriales() {
    ...
    const filteredMateriales = materiales.filter(m => {
        ...
        const matchesStatus = mostrarInactivos || m.activo
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-[#E2E5EB] dark:border-slate-800 p-4">
                    <div className="flex flex-col sm:flex-row gap-4 mb-4">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-3 py-2 border border-[#E2E5EB] dark:border-slate-700 rounded-lg text-sm bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors"
                        >
                            <div className={clsx(
                                "w-9 h-5 rounded-full p-1 transition-colors duration-200",
                                mostrarInactivos ? "bg-[#2B5EA7]" : "bg-gray-300 dark:bg-slate-600"
                            )}>
                                <div className={clsx(
                                    "w-3 h-3 bg-white rounded-full transition-transform duration-200 transform",
                                    mostrarInactivos ? "translate-x-4" : "translate-x-0"
                                )} />
                            </div>
                            <span className="text-gray-600 dark:text-gray-300 font-medium">Mostrar inactivos</span>
                        </button>
                    </div>
